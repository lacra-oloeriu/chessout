...
const TournamentPairingPost = ({title, user, time, avatar, likesCount, likes, commentsCount, comments, isLikedByCurrentUser, tName, tLocation, tPlayersCount}) => {
			...
			<div className="" style={{backgroundColor: '#2f2f2f'}}>
				<CardContent style={{paddingLeft: '50px', paddingRight: '50px'}}>
					<div className="d-flex justify-content-between mb-2">
						<Typography><EventNoteIcon fontSize="small" style={{color: '#198754'}}/> Name</Typography>
						<Typography>{tName}</Typography>
					</div>
					<Divider color={"grey"} />
					<div className="d-flex justify-content-between mt-2 mb-2">
						<Typography><LocationOnOutlinedIcon fontSize="small" style={{marginRight: '4px', color: '#198754'}}/>Location</Typography>
						<Typography>{tLocation}</Typography>
					</div>
					<Divider color={"grey"} />
					<div className="d-flex justify-content-between mt-2">
						<Typography><GroupIcon fontSize="small" style={{marginRight: '4px', color: '#198754'}}/>Registered Players</Typography>
